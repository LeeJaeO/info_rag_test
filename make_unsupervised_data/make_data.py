...
def parse_args():
    ...
    parser.add_argument('--psgs_data_path',
                        type=str,
                        default="//workspace//INFO-RAG//psgs_w100.tsv")
    parser.add_argument(
        '--uns_data_path',
        type=str,
        default="//workspace//INFO-RAG//result",
        help=
        'Save uns data path'
    )
...
if __name__ == "__main__":
    ...
    with open(psgs_data_path, 'r', encoding='utf-8-sig') as r:
        ...
        sub_corpus = corpus_list[:100] #Select 800w passages
                    ...
                    if random_sentence == sentences[i]:
                        ...
                        for i in range(len(sentences)):
                            ...
                            if sentences[i] == random_sentence and not selected_tag:
                                ...
                                print(i)
                                temp_str = 'number {}'.format(i)
                                for t in temp:
                                    temp_str = temp_str + ' ' + t
                                passage_list_new.append(temp_str)
                                data[1] = temp_str#선택된 랜덤 문장
                                score_new.append(0)
                        ...
                        data[3] = score_new #선택된 문장과 다른 문장 간의 거리(점수) 목록.
                        data[2] = passage_list_new #다른 문장들의 목록.
